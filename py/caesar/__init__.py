...
def compiles():
    """caesar.py compiles."""
    check50.uva.py.compile("caesar.py")


@check50.check(compiles)
def encrypts_a_as_b():
    """encrypts "a" as "b" using 1 as key"""
    result = check50.uva.py.run("caesar.py", argv=["caesar.py", "1"], stdin=["a"])
...
def encrypts_barfoo_as_yxocll():
    ...
    result = check50.uva.py.run("caesar.py", argv=["caesar.py", "23"], stdin=["barfoo"])
...
def encrypts_BARFOO_as_EDUIRR():
    ...
    result = check50.uva.py.run("caesar.py", argv=["caesar.py", "3"], stdin=["BARFOO"])
...
def encrypts_BaRFoo_FeVJss():
    ...
    result = check50.uva.py.run("caesar.py", argv=["caesar.py", "4"], stdin=["BaRFoo"])
...
def encrypts_barfoo_as_onesbb():
    ...
    result = check50.uva.py.run("caesar.py", argv=["caesar.py", "65"], stdin=["barfoo"])
...
def checks_for_handling_non_alpha():
    ...
    result = check50.uva.py.run("caesar.py", argv=["caesar.py", "12"], stdin=["world, say hello!"])
...
def handles_no_argv():
    ...
    if not re.match("usage: python caesar.py key", result.stdout):
