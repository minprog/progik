...
def compiles():
    """cash.py compiles"""
    check50.uva.py.compile("cash.py")


@check50.check(compiles)
def test041():
    """input of 0.41 yields output of 4"""
    result = check50.uva.py.run("cash.py", stdin=["0.41"])
...
def test001():
    ...
    result = check50.uva.py.run("cash.py", stdin=["0.01"])
...
def test015():
    ...
    result = check50.uva.py.run("cash.py", stdin=["0.15"])
...
def test160():
    ...
    result = check50.uva.py.run("cash.py", stdin=["1.6"])
...
def test230():
    ...
    result = check50.uva.py.run("cash.py", stdin=["23"])
...
def test420():
    ...
    result = check50.uva.py.run("cash.py", stdin=["4.2"])
...
def test_reject_negative():
    ...
    result = check50.uva.py.run("cash.py", stdin=["-1", "2"])
    if result.stdin:
